          ...
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="batches_id" style="width:200px;" id="batches_id"  class="js-example-basic-single">                                
              ...
              <div class="d-flex justify-content-center">
               <input type="submit" class="btn btn-success mt-3" value="Criar Movimentação"> 
              </div>
                </div>
              </div>
            </div>
